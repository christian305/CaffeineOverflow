...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    &nbsp;<table class="auto-style8">
        <tr>
            ...
            <td class="auto-style2" style="border-style: double double none double; background-color: #C0C0C0; font-style: italic; font-weight: 700;" aria-orientation="horizontal" dir="ltr" draggable="true" rowspan="16">
                <asp:ListBox ID="ListBox2" runat="server" AutoPostBack="True" CssClass="mt-0" DataSourceID="SqlDataSource1" DataTextField="list_name" DataValueField="list_name" Height="655px" OnSelectedIndexChanged="ListBox2_SelectedIndexChanged" Width="254px" ForeColor="Black"></asp:ListBox> 
            </td> 
        ...
        <tr>
            ...
            <td class="auto-style2" visible="false" style="border-style: none double none none; background-color: #C0C0C0; font-style: italic; font-weight: 700;">
                &nbsp;</td>
        </tr>
        <tr>
            ...
            <td id="skills_txt" class="auto-style2" visible="false" style="border-style: none double double double; background-color: #C0C0C0; font-style: italic; font-weight: 700;">
                &nbsp;</td>
        </tr>
        <tr>
